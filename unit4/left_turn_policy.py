...
def optimum_policy2D():
    ...
    while change:
                    ...
                    if goal[0] == x and goal[1] == y:
                        ...
                        for a in range(len(action)):
                            ...
                            if x2 >= 0 and x2 < len(grid) and y2 >= 0 and y2 < len(grid[0]) and grid[x2][y2] == 0:
                                """
                                print "ACTUAL = %s,%d,%d" % (forward_name[o], x, y)
                                print "ACTION = %s" % (action_name[a])
                                print "NEXT = %s,%d,%d" % (forward_name[o2], x2, y2)
                                """
        ...
        """
        for ff, vv in zip(forward_name, value):
            print ff
            for ww in vv:
                print ww
            print "-------------------"
        for ff, vv in zip(forward_name, policy):
            print ff
            for ww in vv:
                print ww
            print "-------------------"
